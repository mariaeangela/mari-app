...
export const CARD_PALETTES = {
  artwork:    { bg: '#51336f', accent: '#c77dff', text: '#f0e6ff', sub: '#cdb8e0', border: '#2a1a4a', tag: '#1e1030' },
  cultura:    { bg: '#682857', accent: '#f25ec8', text: '#ffe9f8', sub: '#f0bcdd', border: '#3a1234', tag: '#250f22' },
  photography:{ bg: '#474e56', accent: '#aebfcf', text: '#eef2f6', sub: '#cfd8e0', border: '#222a32', tag: '#13181d' },
  film:       { bg: '#235473', accent: '#4fc3f7', text: '#e0f4ff', sub: '#b8dcef', border: '#1a3050', tag: '#0d1f38' },
  concept:    { bg: '#2e622e', accent: '#69d869', text: '#e6f5e6', sub: '#bce5bc', border: '#1a3a1a', tag: '#102010' },
  city:       { bg: '#702f1f', accent: '#ff7043', text: '#fff0ec', sub: '#f0bcab', border: '#3a1a10', tag: '#280d0d' },
  letter:     { bg: '#6c581c', accent: '#ffd54f', text: '#fff9e0', sub: '#f0dea0', border: '#3a3000', tag: '#221800' },
  movement:   { bg: '#0e5362', accent: '#26c6da', text: '#e0f8fc', sub: '#a8e0ea', border: '#003040', tag: '#001828' },
  artist:     { bg: '#6a2341', accent: '#f06292', text: '#ffe6f0', sub: '#f0b0c8', border: '#3a0028', tag: '#280018' },
  music:      { bg: '#623d14', accent: '#ff9800', text: '#fff8e6', sub: '#f0cfa0', border: '#1a1a40', tag: '#0d0d28' },
  connection: { bg: '#455e43', accent: '#a5d6a7', text: '#f0f8f0', sub: '#c8e6c9', border: '#203020', tag: '#121f0f' },
  chess:      { bg: '#5d4718', accent: '#d4a843', text: '#fff8e8', sub: '#e6cf90', border: '#3a2800', tag: '#221500' },
  context:    { bg: '#4d2c5c', accent: '#ba68c8', text: '#f5e8ff', sub: '#dcb8e6', border: '#281840', tag: '#150d28' },
  now:        { bg: '#2e5d57', accent: '#80cbc4', text: '#e0faf8', sub: '#aadcd6', border: '#003830', tag: '#002820' },
  philosophy: { bg: '#333970', accent: '#7b86ff', text: '#e8eaff', sub: '#c2c8f0', border: '#1e2148', tag: '#12132e' },
  health:     { bg: '#10624c', accent: '#25d6a4', text: '#e0fff5', sub: '#9ce0cc', border: '#0a3a2c', tag: '#06281f' },
  bible:      { bg: '#5e4726', accent: '#d6a35c', text: '#fff4e2', sub: '#e6c8a0', border: '#3a2c12', tag: '#221908' },
  religion:   { bg: '#632c38', accent: '#e0697e', text: '#ffe9ef', sub: '#f0b0bc', border: '#3a1422', tag: '#260d16' },
  mythology:  { bg: '#633819', accent: '#e0823c', text: '#fff0e2', sub: '#f0c098', border: '#3a1f0a', tag: '#261405' },
};
