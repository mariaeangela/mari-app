...
export const CARD_PALETTES = {
  ...
  philosophy: { bg: '#0b0d20', accent: '#7b86ff', text: '#e8eaff', sub: '#9298c4', border: '#1e2148', tag: '#12132e' },
  health:     { bg: '#04201a', accent: '#25d6a4', text: '#e0fff5', sub: '#74b6a2', border: '#0a3a2c', tag: '#06281f' },
  bible:      { bg: '#1a1308', accent: '#d6a35c', text: '#fff4e2', sub: '#b89a72', border: '#3a2c12', tag: '#221908' },
  religion:   { bg: '#1d0a11', accent: '#e0697e', text: '#ffe9ef', sub: '#bb8493', border: '#3a1422', tag: '#260d16' },
  mythology:  { bg: '#1c0f06', accent: '#e0823c', text: '#fff0e2', sub: '#c0936c', border: '#3a1f0a', tag: '#261405' },
};
