...
function ensureGastos2026Detalhe(d) {
  if (d.gastos2026ImpV9) return d; // V9: Skin care Cabelo/Pele/Outros; V8: Podologia->Saúde; V7-2: Saúde/Mãe/Trabalho/Uber/Mercado
  ...
  const out = { ...d, gastos2026ImpV9: true, gastosItens: [...semSeed, ...novos] };
