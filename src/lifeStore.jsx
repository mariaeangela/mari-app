...
function ensureGastos2026Detalhe(d) {
  if (d.gastos2026ImpV13) return d; // V13: Roupa em baldes; V12: gastos-mãe Presentes->Mãe; V11: Nutricar->Mercado; V10: Bobeira; V9: Skin care; V8: Podologia; V7-2: demais
  ...
  const out = { ...d, gastos2026ImpV13: true, gastosItens: [...semSeed, ...novos] };
