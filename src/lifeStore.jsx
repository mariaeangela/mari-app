...
function ensureGastos2026Detalhe(d) {
  if (d.gastos2026ImpV20) return d; // V20: Rolês em baldes (mapa) + Laços->Presentes/Doação; V19: Fixos; V18: Viagem; V17: Coisas; V16: Coisas baldes; V15: Bolsa/Roupas BZ; V14: Sapatos; V13: Roupa; V12: Presentes->Mãe; V11: Nutricar; V10: Bobeira; V9: Skin care; V8: Podologia; V7-2: demais
  ...
  const out = { ...d, gastos2026ImpV20: true, gastosItens: [...semSeed, ...novos] };
