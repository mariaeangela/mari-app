...
function ensureGastos2026Detalhe(d) {
  if (d.gastos2026ImpV8) return d; // V8: Podologia Skin care->Saúde/Estética; V7: Saúde Outros; V6: Saúde baldes; V5: Mãe; V4: Trabalho; V3: Uber; V2: Mercado
  ...
  const out = { ...d, gastos2026ImpV8: true, gastosItens: [...semSeed, ...novos] };
