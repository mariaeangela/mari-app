...
function ensureGastos2026Detalhe(d) {
  if (d.gastos2026ImpV7) return d; // V7: Saúde Outros; V6: Saúde baldes; V5: Mãe; V4: Trabalho; V3: Uber; V2: Mercado
  ...
  const out = { ...d, gastos2026ImpV7: true, gastosItens: [...semSeed, ...novos] };
