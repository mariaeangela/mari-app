...
function ensureGastos2026Detalhe(d) {
  if (d.gastos2026ImpV2) return d; // V2: Mercado consolidado (Mercado/Nutricar/Cozinha de atleta/Livup)
  ...
  const out = { ...d, gastos2026ImpV2: true, gastosItens: [...semSeed, ...novos] };
