...
function ensureGastos2026Detalhe(d) {
  if (d.gastos2026ImpV12) return d; // V12: gastos-mãe de Presentes->Mãe; V11: Nutricar->Mercado; V10: Bobeira; V9: Skin care; V8: Podologia; V7-2: demais
  ...
  const out = { ...d, gastos2026ImpV12: true, gastosItens: [...semSeed, ...novos] };
